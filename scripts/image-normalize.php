...
$heroKeys = ['hero-island', 'kalanggaman', 'offers-hero', 'about', 'services-hero'];
$general = [
    ...
    'offers-hero'   => "$SRC/offers-hero.jpg",   // Kalanggaman Island sandbar (Leyte)
    'about'         => "$SRC/about.jpg",          // RGE Hotel building (Palompon, Leyte)
    'services-hero' => "$SRC/services-hero.jpg",  // group island-hopping on a Filipino bangka
];
